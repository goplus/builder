...
wasmBinaryFile = "godot.web.editor.wasm32.wasm";
...
var PThread = {
 ...
 allocateUnusedWorker: function() {
  var worker;
  var pthreadMainJs = locateFile("godot.web.editor.wasm32.worker.js");
...
function ___syscall_poll(fds, nfds, timeout) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(24, 1, fds, nfds, timeout);
 try {
  var nonzero = 0;
...
function ___syscall_readlinkat(dirfd, path, buf, bufsize) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(25, 1, dirfd, path, buf, bufsize);
 try {
  path = SYSCALLS.getStr(path);
  path = SYSCALLS.calculateAt(dirfd, path);
...
function ___syscall_recvfrom(fd, buf, len, flags, addr, addrlen) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(26, 1, fd, buf, len, flags, addr, addrlen);
 try {
  var sock = getSocketFromFD(fd);
...
function ___syscall_sendto(fd, message, length, flags, addr, addr_len) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(29, 1, fd, message, length, flags, addr, addr_len);
 try {
  var sock = getSocketFromFD(fd);
...
function ___syscall_statfs64(path, size, buf) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(32, 1, path, size, buf);
 try {
  path = SYSCALLS.getStr(path);
  assert(size === 64);
...
function ___syscall_symlink(target, linkpath) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(33, 1, target, linkpath);
 try {
...
function _godot_js_delete_files_cb(callback) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(59, 1, callback);
...
function _godot_js_on_game_datas_set_callback(callback) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(112, 1, callback);
 const func = GodotRuntime.get_func(callback);
...
function _godot_js_on_load_gdextension(p_name, p_get_proc_address, p_library, r_initialization) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(113, 1, p_name, p_get_proc_address, p_library, r_initialization);
...
function _godot_js_os_download_buffer(p_ptr, p_size, p_name, p_mime) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(114, 1, p_ptr, p_size, p_name, p_mime);
...
function _godot_js_os_execute(p_json) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(115, 1, p_json);
...
function _godot_js_os_finish_async(p_callback) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(116, 1, p_callback);
 const func = GodotRuntime.get_func(p_callback);
...
function _godot_js_os_fs_sync(callback) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(118, 1, callback);
 const func = GodotRuntime.get_func(callback);
...
function _godot_js_os_has_feature(p_ftr) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(119, 1, p_ftr);
...
function _godot_js_os_on_fs_sync_done() {
...
function _godot_js_os_on_main_iterater(p_frame_num) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(122, 1, p_frame_num);
 GodotOS._frame_num = p_frame_num;
}

function _godot_js_os_refresh_fs() {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(123, 1);
 GodotFS.refresh_fs();
}

function _godot_js_os_request_quit_cb(p_callback) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(124, 1, p_callback);
 GodotOS.request_quit = GodotRuntime.get_func(p_callback);
}

function _godot_js_os_shell_open(p_uri) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(125, 1, p_uri);
...
function _godot_js_pwa_cb(p_update_cb) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(126, 1, p_update_cb);
...
function _godot_js_pwa_update() {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(127, 1);
...
function _godot_js_rtc_datachannel_connect(p_id, p_ref, p_on_open, p_on_message, p_on_error, p_on_close) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(129, 1, p_id, p_ref, p_on_open, p_on_message, p_on_error, p_on_close);
...
function _godot_js_rtc_datachannel_send(p_id, p_buffer, p_length, p_raw) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(139, 1, p_id, p_buffer, p_length, p_raw);
 const ref = IDHandler.get(p_id);
 if (!ref) {
  return 1;
 }
...
function _godot_js_rtc_pc_close(p_id) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(140, 1, p_id);
 const ref = IDHandler.get(p_id);
 if (!ref) {
  return;
 }
...
function _godot_js_rtc_pc_create(p_config, p_ref, p_on_connection_state_change, p_on_ice_gathering_state_change, p_on_signaling_state_change, p_on_ice_candidate, p_on_datachannel) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(141, 1, p_config, p_ref, p_on_connection_state_change, p_on_ice_gathering_state_change, p_on_signaling_state_change, p_on_ice_candidate, p_on_datachannel);
...
function _godot_js_rtc_pc_datachannel_create(p_id, p_label, p_config) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(142, 1, p_id, p_label, p_config);
 try {
  const ref = IDHandler.get(p_id);
  if (!ref) {
   return 0;
...
function _godot_js_rtc_pc_destroy(p_id) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(143, 1, p_id);
 GodotRTCPeerConnection.destroy(p_id);
}

function _godot_js_rtc_pc_ice_candidate_add(p_id, p_mid_name, p_mline_idx, p_sdp) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(144, 1, p_id, p_mid_name, p_mline_idx, p_sdp);
 const ref = IDHandler.get(p_id);
 if (!ref) {
  return;
 }
...
function _godot_js_rtc_pc_local_description_set(p_id, p_type, p_sdp, p_obj, p_on_error) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(145, 1, p_id, p_type, p_sdp, p_obj, p_on_error);
 const ref = IDHandler.get(p_id);
 if (!ref) {
  return;
 }
...
function _godot_js_rtc_pc_offer_create(p_id, p_obj, p_on_session, p_on_error) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(146, 1, p_id, p_obj, p_on_session, p_on_error);
 const ref = IDHandler.get(p_id);
 if (!ref) {
  return;
 }
...
function _godot_js_rtc_pc_remote_description_set(p_id, p_type, p_sdp, p_obj, p_session_created, p_on_error) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(147, 1, p_id, p_type, p_sdp, p_obj, p_session_created, p_on_error);
 const ref = IDHandler.get(p_id);
 if (!ref) {
  return;
 }
...
function _godot_js_select_dir_cb(p_callback) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(148, 1, p_callback);
 const func = GodotRuntime.get_func(p_callback);
...
function _godot_js_spx_on_action_just_pressed(action_name) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(149, 1, action_name);
...
function _godot_js_spx_on_action_just_released(action_name) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(150, 1, action_name);
...
function _godot_js_spx_on_action_pressed(action_name) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(151, 1, action_name);
...
function _godot_js_spx_on_axis_changed(action_name, value) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(152, 1, action_name, value);
...
function _godot_js_spx_on_collision_enter(self_id, other_id) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(153, 1, self_id, other_id);
...
function _godot_js_spx_on_collision_exit(self_id, other_id) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(154, 1, self_id, other_id);
...
function _godot_js_spx_on_collision_stay(self_id, other_id) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(155, 1, self_id, other_id);
...
function _godot_js_spx_on_scene_sprite_instantiated(obj, type_name) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(164, 1, obj, type_name);
...
function _godot_js_spx_on_trigger_exit(self_id, other_id) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(178, 1, self_id, other_id);
...
function _godot_js_spx_on_trigger_stay(self_id, other_id) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(179, 1, self_id, other_id);
...
function _godot_js_spx_on_ui_toggle(obj, is_on) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(187, 1, obj, is_on);
 window.gdspx_on_ui_toggle(GodotRuntime.ToJsObj(obj), is_on);
}

function _godot_js_spx_on_ui_updated(obj) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(188, 1, obj);
 window.gdspx_on_ui_updated(GodotRuntime.ToJsObj(obj));
}

function _godot_js_tts_get_voices(p_callback) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(189, 1, p_callback);
 const func = GodotRuntime.get_func(p_callback);
 try {
  const arr = [];
...
function _godot_js_tts_is_paused() {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(190, 1);
 return window.speechSynthesis.paused;
}

function _godot_js_tts_is_speaking() {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(191, 1);
 return window.speechSynthesis.speaking;
}

function _godot_js_tts_pause() {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(192, 1);
...
function _godot_js_tts_speak(p_text, p_voice, p_volume, p_pitch, p_rate, p_utterance_id, p_callback) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(194, 1, p_text, p_voice, p_volume, p_pitch, p_rate, p_utterance_id, p_callback);
 const func = GodotRuntime.get_func(p_callback);
...
function _godot_js_tts_stop() {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(195, 1);
 window.speechSynthesis.cancel();
 window.speechSynthesis.resume();
}

function _godot_js_update_files_cb(callback) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(196, 1, callback);
 const func = GodotRuntime.get_func(callback);
...
function _godot_js_websocket_buffered_amount(p_id) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(197, 1, p_id);
 return GodotWebSocket.bufferedAmount(p_id);
}

function _godot_js_websocket_close(p_id, p_code, p_reason) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(198, 1, p_id, p_code, p_reason);
 const code = p_code;
...
function _godot_js_websocket_create(p_ref, p_url, p_proto, p_on_open, p_on_message, p_on_error, p_on_close) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(199, 1, p_ref, p_url, p_proto, p_on_open, p_on_message, p_on_error, p_on_close);
...
function _godot_js_websocket_destroy(p_id) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(200, 1, p_id);
 GodotWebSocket.destroy(p_id);
}

function _godot_js_websocket_send(p_id, p_buf, p_buf_len, p_raw) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(201, 1, p_id, p_buf, p_buf_len, p_raw);
...
function _godot_js_wrapper_create_cb(p_ref, p_func) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(202, 1, p_ref, p_func);
...
function _godot_js_wrapper_create_object(p_object, p_args, p_argc, p_convert_callback, p_exchange, p_lock, p_free_lock_callback) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(203, 1, p_object, p_args, p_argc, p_convert_callback, p_exchange, p_lock, p_free_lock_callback);
...
function _godot_js_wrapper_interface_get(p_name) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(204, 1, p_name);
 const name = GodotRuntime.parseString(p_name);
 if (typeof window[name] !== "undefined") {
...
function _godot_js_wrapper_object_call(p_id, p_method, p_args, p_argc, p_convert_callback, p_exchange, p_lock, p_free_lock_callback) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(205, 1, p_id, p_method, p_args, p_argc, p_convert_callback, p_exchange, p_lock, p_free_lock_callback);
...
function _godot_js_wrapper_object_get(p_id, p_exchange, p_prop) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(206, 1, p_id, p_exchange, p_prop);
 const obj = GodotJSWrapper.get_proxied_value(p_id);
 if (obj === undefined) {
  return 0;
 }
...
function _godot_js_wrapper_object_getvar(p_id, p_type, p_exchange) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(207, 1, p_id, p_type, p_exchange);
 const obj = GodotJSWrapper.get_proxied_value(p_id);
 if (obj === undefined) {
  return -1;
 }
...
function _godot_js_wrapper_object_set(p_id, p_name, p_type, p_exchange) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(208, 1, p_id, p_name, p_type, p_exchange);
 const obj = GodotJSWrapper.get_proxied_value(p_id);
 if (obj === undefined) {
  return;
 }
...
function _godot_js_wrapper_object_set_cb_ret(p_val_type, p_val_ex) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(209, 1, p_val_type, p_val_ex);
...
function _godot_js_wrapper_object_setvar(p_id, p_key_type, p_key_ex, p_val_type, p_val_ex) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(210, 1, p_id, p_key_type, p_key_ex, p_val_type, p_val_ex);
 const obj = GodotJSWrapper.get_proxied_value(p_id);
 if (obj === undefined) {
  return -1;
 }
...
function _godot_js_wrapper_object_unref(p_id) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(211, 1, p_id);
...
function _godot_webgl2_glFramebufferTextureMultiviewOVR(target, attachment, texture, level, base_view_index, num_views) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(212, 1, target, attachment, texture, level, base_view_index, num_views);
...
function _godot_webgl2_glGetBufferSubData(target, offset, size, data) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(213, 1, target, offset, size, data);
 const gl_context_handle = _emscripten_webgl_get_current_context();
 const gl = GL.getContext(gl_context_handle);
 if (gl) {
...
function _godot_webxr_get_bounds_geometry(r_points) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(214, 1, r_points);
...
function _godot_webxr_get_color_texture() {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(215, 1);
...
function _godot_webxr_get_depth_texture() {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(216, 1);
 const subimage = GodotWebXR.getSubImage();
 if (subimage === null) {
  return 0;
 }
...
function _godot_webxr_get_frame_rate() {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(217, 1);
...
function _godot_webxr_get_projection_for_view(p_view, r_transform) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(218, 1, p_view, r_transform);
...
function _godot_webxr_get_render_target_size(r_size) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(219, 1, r_size);
 const subimage = GodotWebXR.getSubImage();
 if (subimage === null) {
  return false;
 }
...
function _godot_webxr_get_supported_frame_rates(r_frame_rates) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(220, 1, r_frame_rates);
...
function _godot_webxr_get_transform_for_view(p_view, r_transform) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(221, 1, p_view, r_transform);
 if (!GodotWebXR.session || !GodotWebXR.pose) {
  return false;
 }
...
function _godot_webxr_get_velocity_texture() {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(222, 1);
 const subimage = GodotWebXR.getSubImage();
 if (subimage === null) {
  return 0;
 }
...
function _godot_webxr_get_view_count() {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(223, 1);
 if (!GodotWebXR.session || !GodotWebXR.pose) {
  return 1;
 }
...
function _godot_webxr_get_visibility_state() {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(224, 1);
...
function _godot_webxr_initialize(p_session_mode, p_required_features, p_optional_features, p_requested_reference_spaces, p_on_session_started, p_on_session_ended, p_on_session_failed, p_on_input_event, p_on_simple_event) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(225, 1, p_session_mode, p_required_features, p_optional_features, p_requested_reference_spaces, p_on_session_started, p_on_session_ended, p_on_session_failed, p_on_input_event, p_on_simple_event);
...
function _godot_webxr_is_session_supported(p_session_mode, p_callback) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(226, 1, p_session_mode, p_callback);
 const session_mode = GodotRuntime.parseString(p_session_mode);
...
function _godot_webxr_uninitialize() {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(228, 1);
...
function _godot_webxr_update_input_source(p_input_source_id, r_target_pose, r_target_ray_mode, r_touch_index, r_has_grip_pose, r_grip_pose, r_has_standard_mapping, r_button_count, r_buttons, r_axes_count, r_axes) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(229, 1, p_input_source_id, r_target_pose, r_target_ray_mode, r_touch_index, r_has_grip_pose, r_grip_pose, r_has_standard_mapping, r_button_count, r_buttons, r_axes_count, r_axes);
...
function _godot_webxr_update_target_frame_rate(p_frame_rate) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(230, 1, p_frame_rate);
...
var wasmImports = {
 ...
 "godot_js_delete_files_cb": _godot_js_delete_files_cb,
 ...
 "godot_js_on_game_datas_set_callback": _godot_js_on_game_datas_set_callback,
 "godot_js_on_load_gdextension": _godot_js_on_load_gdextension,
 ...
 "godot_js_os_on_fs_sync_done": _godot_js_os_on_fs_sync_done,
 "godot_js_os_on_main_iterater": _godot_js_os_on_main_iterater,
 "godot_js_os_refresh_fs": _godot_js_os_refresh_fs,
 ...
 "godot_js_select_dir_cb": _godot_js_select_dir_cb,
 "godot_js_spx_on_action_just_pressed": _godot_js_spx_on_action_just_pressed,
 "godot_js_spx_on_action_just_released": _godot_js_spx_on_action_just_released,
 "godot_js_spx_on_action_pressed": _godot_js_spx_on_action_pressed,
 "godot_js_spx_on_axis_changed": _godot_js_spx_on_axis_changed,
 "godot_js_spx_on_collision_enter": _godot_js_spx_on_collision_enter,
 "godot_js_spx_on_collision_exit": _godot_js_spx_on_collision_exit,
 "godot_js_spx_on_collision_stay": _godot_js_spx_on_collision_stay,
 "godot_js_spx_on_engine_destroy": _godot_js_spx_on_engine_destroy,
 "godot_js_spx_on_engine_fixed_update": _godot_js_spx_on_engine_fixed_update,
 "godot_js_spx_on_engine_start": _godot_js_spx_on_engine_start,
 "godot_js_spx_on_engine_update": _godot_js_spx_on_engine_update,
 "godot_js_spx_on_key_pressed": _godot_js_spx_on_key_pressed,
 "godot_js_spx_on_key_released": _godot_js_spx_on_key_released,
 "godot_js_spx_on_mouse_pressed": _godot_js_spx_on_mouse_pressed,
 "godot_js_spx_on_mouse_released": _godot_js_spx_on_mouse_released,
 "godot_js_spx_on_scene_sprite_instantiated": _godot_js_spx_on_scene_sprite_instantiated,
 "godot_js_spx_on_sprite_animation_changed": _godot_js_spx_on_sprite_animation_changed,
 ...
 "godot_js_spx_on_sprite_destroyed": _godot_js_spx_on_sprite_destroyed,
 "godot_js_spx_on_sprite_fixed_updated": _godot_js_spx_on_sprite_fixed_updated,
 "godot_js_spx_on_sprite_frame_changed": _godot_js_spx_on_sprite_frame_changed,
 "godot_js_spx_on_sprite_frames_set_changed": _godot_js_spx_on_sprite_frames_set_changed,
 "godot_js_spx_on_sprite_ready": _godot_js_spx_on_sprite_ready,
 "godot_js_spx_on_sprite_screen_entered": _godot_js_spx_on_sprite_screen_entered,
 "godot_js_spx_on_sprite_screen_exited": _godot_js_spx_on_sprite_screen_exited,
 "godot_js_spx_on_sprite_updated": _godot_js_spx_on_sprite_updated,
 "godot_js_spx_on_sprite_vfx_finished": _godot_js_spx_on_sprite_vfx_finished,
 "godot_js_spx_on_trigger_enter": _godot_js_spx_on_trigger_enter,
 "godot_js_spx_on_trigger_exit": _godot_js_spx_on_trigger_exit,
 "godot_js_spx_on_trigger_stay": _godot_js_spx_on_trigger_stay,
 "godot_js_spx_on_ui_clicked": _godot_js_spx_on_ui_clicked,
 "godot_js_spx_on_ui_destroyed": _godot_js_spx_on_ui_destroyed,
 "godot_js_spx_on_ui_hovered": _godot_js_spx_on_ui_hovered,
 "godot_js_spx_on_ui_pressed": _godot_js_spx_on_ui_pressed,
 "godot_js_spx_on_ui_ready": _godot_js_spx_on_ui_ready,
 "godot_js_spx_on_ui_released": _godot_js_spx_on_ui_released,
 "godot_js_spx_on_ui_text_changed": _godot_js_spx_on_ui_text_changed,
 "godot_js_spx_on_ui_toggle": _godot_js_spx_on_ui_toggle,
 "godot_js_spx_on_ui_updated": _godot_js_spx_on_ui_updated,
 ...
 "godot_js_update_files_cb": _godot_js_update_files_cb,
...
var _gdspx_audio_stop_all = Module["_gdspx_audio_stop_all"] = createExportWrapper("gdspx_audio_stop_all");

var _gdspx_audio_play_sfx = Module["_gdspx_audio_play_sfx"] = createExportWrapper("gdspx_audio_play_sfx");

var _gdspx_audio_play_music = Module["_gdspx_audio_play_music"] = createExportWrapper("gdspx_audio_play_music");

var _gdspx_audio_pause_music = Module["_gdspx_audio_pause_music"] = createExportWrapper("gdspx_audio_pause_music");

var _gdspx_audio_resume_music = Module["_gdspx_audio_resume_music"] = createExportWrapper("gdspx_audio_resume_music");

var _gdspx_audio_get_music_timer = Module["_gdspx_audio_get_music_timer"] = createExportWrapper("gdspx_audio_get_music_timer");

var _gdspx_audio_set_music_timer = Module["_gdspx_audio_set_music_timer"] = createExportWrapper("gdspx_audio_set_music_timer");

var _gdspx_audio_is_music_playing = Module["_gdspx_audio_is_music_playing"] = createExportWrapper("gdspx_audio_is_music_playing");

var _gdspx_audio_set_sfx_volume = Module["_gdspx_audio_set_sfx_volume"] = createExportWrapper("gdspx_audio_set_sfx_volume");

var _gdspx_audio_get_sfx_volume = Module["_gdspx_audio_get_sfx_volume"] = createExportWrapper("gdspx_audio_get_sfx_volume");

var _gdspx_audio_set_music_volume = Module["_gdspx_audio_set_music_volume"] = createExportWrapper("gdspx_audio_set_music_volume");

var _gdspx_audio_get_music_volume = Module["_gdspx_audio_get_music_volume"] = createExportWrapper("gdspx_audio_get_music_volume");

var _gdspx_audio_set_master_volume = Module["_gdspx_audio_set_master_volume"] = createExportWrapper("gdspx_audio_set_master_volume");

var _gdspx_audio_get_master_volume = Module["_gdspx_audio_get_master_volume"] = createExportWrapper("gdspx_audio_get_master_volume");

var _gdspx_camera_get_camera_position = Module["_gdspx_camera_get_camera_position"] = createExportWrapper("gdspx_camera_get_camera_position");

var _gdspx_camera_set_camera_position = Module["_gdspx_camera_set_camera_position"] = createExportWrapper("gdspx_camera_set_camera_position");

var _gdspx_camera_get_camera_zoom = Module["_gdspx_camera_get_camera_zoom"] = createExportWrapper("gdspx_camera_get_camera_zoom");

var _gdspx_camera_set_camera_zoom = Module["_gdspx_camera_set_camera_zoom"] = createExportWrapper("gdspx_camera_set_camera_zoom");

var _gdspx_camera_get_viewport_rect = Module["_gdspx_camera_get_viewport_rect"] = createExportWrapper("gdspx_camera_get_viewport_rect");

var _gdspx_input_get_mouse_pos = Module["_gdspx_input_get_mouse_pos"] = createExportWrapper("gdspx_input_get_mouse_pos");

var _gdspx_input_get_key = Module["_gdspx_input_get_key"] = createExportWrapper("gdspx_input_get_key");

var _gdspx_input_get_mouse_state = Module["_gdspx_input_get_mouse_state"] = createExportWrapper("gdspx_input_get_mouse_state");

var _gdspx_input_get_key_state = Module["_gdspx_input_get_key_state"] = createExportWrapper("gdspx_input_get_key_state");

var _gdspx_input_get_axis = Module["_gdspx_input_get_axis"] = createExportWrapper("gdspx_input_get_axis");

var _gdspx_input_is_action_pressed = Module["_gdspx_input_is_action_pressed"] = createExportWrapper("gdspx_input_is_action_pressed");

var _gdspx_input_is_action_just_pressed = Module["_gdspx_input_is_action_just_pressed"] = createExportWrapper("gdspx_input_is_action_just_pressed");

var _gdspx_input_is_action_just_released = Module["_gdspx_input_is_action_just_released"] = createExportWrapper("gdspx_input_is_action_just_released");

var _gdspx_physic_raycast = Module["_gdspx_physic_raycast"] = createExportWrapper("gdspx_physic_raycast");

var _gdspx_physic_check_collision = Module["_gdspx_physic_check_collision"] = createExportWrapper("gdspx_physic_check_collision");

var _gdspx_physic_check_touched_camera_boundary = Module["_gdspx_physic_check_touched_camera_boundary"] = createExportWrapper("gdspx_physic_check_touched_camera_boundary");

var _gdspx_platform_set_window_position = Module["_gdspx_platform_set_window_position"] = createExportWrapper("gdspx_platform_set_window_position");

var _gdspx_platform_get_window_position = Module["_gdspx_platform_get_window_position"] = createExportWrapper("gdspx_platform_get_window_position");

var _gdspx_platform_set_window_size = Module["_gdspx_platform_set_window_size"] = createExportWrapper("gdspx_platform_set_window_size");

var _gdspx_platform_get_window_size = Module["_gdspx_platform_get_window_size"] = createExportWrapper("gdspx_platform_get_window_size");

var _gdspx_platform_set_window_title = Module["_gdspx_platform_set_window_title"] = createExportWrapper("gdspx_platform_set_window_title");

var _gdspx_platform_get_window_title = Module["_gdspx_platform_get_window_title"] = createExportWrapper("gdspx_platform_get_window_title");

var _gdspx_platform_set_window_fullscreen = Module["_gdspx_platform_set_window_fullscreen"] = createExportWrapper("gdspx_platform_set_window_fullscreen");

var _gdspx_platform_is_window_fullscreen = Module["_gdspx_platform_is_window_fullscreen"] = createExportWrapper("gdspx_platform_is_window_fullscreen");

var _gdspx_platform_set_debug_mode = Module["_gdspx_platform_set_debug_mode"] = createExportWrapper("gdspx_platform_set_debug_mode");

var _gdspx_platform_is_debug_mode = Module["_gdspx_platform_is_debug_mode"] = createExportWrapper("gdspx_platform_is_debug_mode");

var _gdspx_res_set_load_mode = Module["_gdspx_res_set_load_mode"] = createExportWrapper("gdspx_res_set_load_mode");

var _gdspx_res_get_load_mode = Module["_gdspx_res_get_load_mode"] = createExportWrapper("gdspx_res_get_load_mode");
...
var _gdspx_res_has_file = Module["_gdspx_res_has_file"] = createExportWrapper("gdspx_res_has_file");

var _gdspx_scene_change_scene_to_file = Module["_gdspx_scene_change_scene_to_file"] = createExportWrapper("gdspx_scene_change_scene_to_file");

var _gdspx_scene_reload_current_scene = Module["_gdspx_scene_reload_current_scene"] = createExportWrapper("gdspx_scene_reload_current_scene");

var _gdspx_scene_unload_current_scene = Module["_gdspx_scene_unload_current_scene"] = createExportWrapper("gdspx_scene_unload_current_scene");

var _gdspx_sprite_set_dont_destroy_on_load = Module["_gdspx_sprite_set_dont_destroy_on_load"] = createExportWrapper("gdspx_sprite_set_dont_destroy_on_load");

var _gdspx_sprite_set_process = Module["_gdspx_sprite_set_process"] = createExportWrapper("gdspx_sprite_set_process");

var _gdspx_sprite_set_physic_process = Module["_gdspx_sprite_set_physic_process"] = createExportWrapper("gdspx_sprite_set_physic_process");

var _gdspx_sprite_set_child_position = Module["_gdspx_sprite_set_child_position"] = createExportWrapper("gdspx_sprite_set_child_position");

var _gdspx_sprite_get_child_position = Module["_gdspx_sprite_get_child_position"] = createExportWrapper("gdspx_sprite_get_child_position");

var _gdspx_sprite_set_child_rotation = Module["_gdspx_sprite_set_child_rotation"] = createExportWrapper("gdspx_sprite_set_child_rotation");

var _gdspx_sprite_get_child_rotation = Module["_gdspx_sprite_get_child_rotation"] = createExportWrapper("gdspx_sprite_get_child_rotation");

var _gdspx_sprite_set_child_scale = Module["_gdspx_sprite_set_child_scale"] = createExportWrapper("gdspx_sprite_set_child_scale");

var _gdspx_sprite_get_child_scale = Module["_gdspx_sprite_get_child_scale"] = createExportWrapper("gdspx_sprite_get_child_scale");

var _gdspx_sprite_check_collision = Module["_gdspx_sprite_check_collision"] = createExportWrapper("gdspx_sprite_check_collision");

var _gdspx_sprite_check_collision_with_point = Module["_gdspx_sprite_check_collision_with_point"] = createExportWrapper("gdspx_sprite_check_collision_with_point");

var _gdspx_sprite_create_sprite = Module["_gdspx_sprite_create_sprite"] = createExportWrapper("gdspx_sprite_create_sprite");

var _gdspx_sprite_clone_sprite = Module["_gdspx_sprite_clone_sprite"] = createExportWrapper("gdspx_sprite_clone_sprite");

var _gdspx_sprite_destroy_sprite = Module["_gdspx_sprite_destroy_sprite"] = createExportWrapper("gdspx_sprite_destroy_sprite");

var _gdspx_sprite_is_sprite_alive = Module["_gdspx_sprite_is_sprite_alive"] = createExportWrapper("gdspx_sprite_is_sprite_alive");

var _gdspx_sprite_set_position = Module["_gdspx_sprite_set_position"] = createExportWrapper("gdspx_sprite_set_position");

var _gdspx_sprite_get_position = Module["_gdspx_sprite_get_position"] = createExportWrapper("gdspx_sprite_get_position");

var _gdspx_sprite_set_rotation = Module["_gdspx_sprite_set_rotation"] = createExportWrapper("gdspx_sprite_set_rotation");

var _gdspx_sprite_get_rotation = Module["_gdspx_sprite_get_rotation"] = createExportWrapper("gdspx_sprite_get_rotation");

var _gdspx_sprite_set_scale = Module["_gdspx_sprite_set_scale"] = createExportWrapper("gdspx_sprite_set_scale");

var _gdspx_sprite_get_scale = Module["_gdspx_sprite_get_scale"] = createExportWrapper("gdspx_sprite_get_scale");

var _gdspx_sprite_set_render_scale = Module["_gdspx_sprite_set_render_scale"] = createExportWrapper("gdspx_sprite_set_render_scale");

var _gdspx_sprite_get_render_scale = Module["_gdspx_sprite_get_render_scale"] = createExportWrapper("gdspx_sprite_get_render_scale");

var _gdspx_sprite_set_color = Module["_gdspx_sprite_set_color"] = createExportWrapper("gdspx_sprite_set_color");

var _gdspx_sprite_get_color = Module["_gdspx_sprite_get_color"] = createExportWrapper("gdspx_sprite_get_color");

var _gdspx_sprite_set_texture_altas = Module["_gdspx_sprite_set_texture_altas"] = createExportWrapper("gdspx_sprite_set_texture_altas");

var _gdspx_sprite_set_texture = Module["_gdspx_sprite_set_texture"] = createExportWrapper("gdspx_sprite_set_texture");

var _gdspx_sprite_get_texture = Module["_gdspx_sprite_get_texture"] = createExportWrapper("gdspx_sprite_get_texture");

var _gdspx_sprite_set_visible = Module["_gdspx_sprite_set_visible"] = createExportWrapper("gdspx_sprite_set_visible");

var _gdspx_sprite_get_visible = Module["_gdspx_sprite_get_visible"] = createExportWrapper("gdspx_sprite_get_visible");

var _gdspx_sprite_get_z_index = Module["_gdspx_sprite_get_z_index"] = createExportWrapper("gdspx_sprite_get_z_index");

var _gdspx_sprite_set_z_index = Module["_gdspx_sprite_set_z_index"] = createExportWrapper("gdspx_sprite_set_z_index");

var _gdspx_sprite_play_anim = Module["_gdspx_sprite_play_anim"] = createExportWrapper("gdspx_sprite_play_anim");

var _gdspx_sprite_play_backwards_anim = Module["_gdspx_sprite_play_backwards_anim"] = createExportWrapper("gdspx_sprite_play_backwards_anim");

var _gdspx_sprite_pause_anim = Module["_gdspx_sprite_pause_anim"] = createExportWrapper("gdspx_sprite_pause_anim");

var _gdspx_sprite_stop_anim = Module["_gdspx_sprite_stop_anim"] = createExportWrapper("gdspx_sprite_stop_anim");

var _gdspx_sprite_is_playing_anim = Module["_gdspx_sprite_is_playing_anim"] = createExportWrapper("gdspx_sprite_is_playing_anim");

var _gdspx_sprite_set_anim = Module["_gdspx_sprite_set_anim"] = createExportWrapper("gdspx_sprite_set_anim");

var _gdspx_sprite_get_anim = Module["_gdspx_sprite_get_anim"] = createExportWrapper("gdspx_sprite_get_anim");

var _gdspx_sprite_set_anim_frame = Module["_gdspx_sprite_set_anim_frame"] = createExportWrapper("gdspx_sprite_set_anim_frame");

var _gdspx_sprite_get_anim_frame = Module["_gdspx_sprite_get_anim_frame"] = createExportWrapper("gdspx_sprite_get_anim_frame");

var _gdspx_sprite_set_anim_speed_scale = Module["_gdspx_sprite_set_anim_speed_scale"] = createExportWrapper("gdspx_sprite_set_anim_speed_scale");

var _gdspx_sprite_get_anim_speed_scale = Module["_gdspx_sprite_get_anim_speed_scale"] = createExportWrapper("gdspx_sprite_get_anim_speed_scale");

var _gdspx_sprite_get_anim_playing_speed = Module["_gdspx_sprite_get_anim_playing_speed"] = createExportWrapper("gdspx_sprite_get_anim_playing_speed");

var _gdspx_sprite_set_anim_centered = Module["_gdspx_sprite_set_anim_centered"] = createExportWrapper("gdspx_sprite_set_anim_centered");

var _gdspx_sprite_is_anim_centered = Module["_gdspx_sprite_is_anim_centered"] = createExportWrapper("gdspx_sprite_is_anim_centered");

var _gdspx_sprite_set_anim_offset = Module["_gdspx_sprite_set_anim_offset"] = createExportWrapper("gdspx_sprite_set_anim_offset");

var _gdspx_sprite_get_anim_offset = Module["_gdspx_sprite_get_anim_offset"] = createExportWrapper("gdspx_sprite_get_anim_offset");

var _gdspx_sprite_set_anim_flip_h = Module["_gdspx_sprite_set_anim_flip_h"] = createExportWrapper("gdspx_sprite_set_anim_flip_h");

var _gdspx_sprite_is_anim_flipped_h = Module["_gdspx_sprite_is_anim_flipped_h"] = createExportWrapper("gdspx_sprite_is_anim_flipped_h");

var _gdspx_sprite_set_anim_flip_v = Module["_gdspx_sprite_set_anim_flip_v"] = createExportWrapper("gdspx_sprite_set_anim_flip_v");

var _gdspx_sprite_is_anim_flipped_v = Module["_gdspx_sprite_is_anim_flipped_v"] = createExportWrapper("gdspx_sprite_is_anim_flipped_v");

var _gdspx_sprite_set_velocity = Module["_gdspx_sprite_set_velocity"] = createExportWrapper("gdspx_sprite_set_velocity");

var _gdspx_sprite_get_velocity = Module["_gdspx_sprite_get_velocity"] = createExportWrapper("gdspx_sprite_get_velocity");

var _gdspx_sprite_is_on_floor = Module["_gdspx_sprite_is_on_floor"] = createExportWrapper("gdspx_sprite_is_on_floor");

var _gdspx_sprite_is_on_floor_only = Module["_gdspx_sprite_is_on_floor_only"] = createExportWrapper("gdspx_sprite_is_on_floor_only");

var _gdspx_sprite_is_on_wall = Module["_gdspx_sprite_is_on_wall"] = createExportWrapper("gdspx_sprite_is_on_wall");

var _gdspx_sprite_is_on_wall_only = Module["_gdspx_sprite_is_on_wall_only"] = createExportWrapper("gdspx_sprite_is_on_wall_only");

var _gdspx_sprite_is_on_ceiling = Module["_gdspx_sprite_is_on_ceiling"] = createExportWrapper("gdspx_sprite_is_on_ceiling");

var _gdspx_sprite_is_on_ceiling_only = Module["_gdspx_sprite_is_on_ceiling_only"] = createExportWrapper("gdspx_sprite_is_on_ceiling_only");

var _gdspx_sprite_get_last_motion = Module["_gdspx_sprite_get_last_motion"] = createExportWrapper("gdspx_sprite_get_last_motion");

var _gdspx_sprite_get_position_delta = Module["_gdspx_sprite_get_position_delta"] = createExportWrapper("gdspx_sprite_get_position_delta");

var _gdspx_sprite_get_floor_normal = Module["_gdspx_sprite_get_floor_normal"] = createExportWrapper("gdspx_sprite_get_floor_normal");

var _gdspx_sprite_get_wall_normal = Module["_gdspx_sprite_get_wall_normal"] = createExportWrapper("gdspx_sprite_get_wall_normal");

var _gdspx_sprite_get_real_velocity = Module["_gdspx_sprite_get_real_velocity"] = createExportWrapper("gdspx_sprite_get_real_velocity");

var _gdspx_sprite_move_and_slide = Module["_gdspx_sprite_move_and_slide"] = createExportWrapper("gdspx_sprite_move_and_slide");

var _gdspx_sprite_set_gravity = Module["_gdspx_sprite_set_gravity"] = createExportWrapper("gdspx_sprite_set_gravity");

var _gdspx_sprite_get_gravity = Module["_gdspx_sprite_get_gravity"] = createExportWrapper("gdspx_sprite_get_gravity");

var _gdspx_sprite_set_mass = Module["_gdspx_sprite_set_mass"] = createExportWrapper("gdspx_sprite_set_mass");

var _gdspx_sprite_get_mass = Module["_gdspx_sprite_get_mass"] = createExportWrapper("gdspx_sprite_get_mass");

var _gdspx_sprite_add_force = Module["_gdspx_sprite_add_force"] = createExportWrapper("gdspx_sprite_add_force");

var _gdspx_sprite_add_impulse = Module["_gdspx_sprite_add_impulse"] = createExportWrapper("gdspx_sprite_add_impulse");

var _gdspx_sprite_set_collision_layer = Module["_gdspx_sprite_set_collision_layer"] = createExportWrapper("gdspx_sprite_set_collision_layer");

var _gdspx_sprite_get_collision_layer = Module["_gdspx_sprite_get_collision_layer"] = createExportWrapper("gdspx_sprite_get_collision_layer");

var _gdspx_sprite_set_collision_mask = Module["_gdspx_sprite_set_collision_mask"] = createExportWrapper("gdspx_sprite_set_collision_mask");

var _gdspx_sprite_get_collision_mask = Module["_gdspx_sprite_get_collision_mask"] = createExportWrapper("gdspx_sprite_get_collision_mask");

var _gdspx_sprite_set_trigger_layer = Module["_gdspx_sprite_set_trigger_layer"] = createExportWrapper("gdspx_sprite_set_trigger_layer");

var _gdspx_sprite_get_trigger_layer = Module["_gdspx_sprite_get_trigger_layer"] = createExportWrapper("gdspx_sprite_get_trigger_layer");

var _gdspx_sprite_set_trigger_mask = Module["_gdspx_sprite_set_trigger_mask"] = createExportWrapper("gdspx_sprite_set_trigger_mask");

var _gdspx_sprite_get_trigger_mask = Module["_gdspx_sprite_get_trigger_mask"] = createExportWrapper("gdspx_sprite_get_trigger_mask");

var _gdspx_sprite_set_collider_rect = Module["_gdspx_sprite_set_collider_rect"] = createExportWrapper("gdspx_sprite_set_collider_rect");

var _gdspx_sprite_set_collider_circle = Module["_gdspx_sprite_set_collider_circle"] = createExportWrapper("gdspx_sprite_set_collider_circle");

var _gdspx_sprite_set_collider_capsule = Module["_gdspx_sprite_set_collider_capsule"] = createExportWrapper("gdspx_sprite_set_collider_capsule");

var _gdspx_sprite_set_collision_enabled = Module["_gdspx_sprite_set_collision_enabled"] = createExportWrapper("gdspx_sprite_set_collision_enabled");

var _gdspx_sprite_is_collision_enabled = Module["_gdspx_sprite_is_collision_enabled"] = createExportWrapper("gdspx_sprite_is_collision_enabled");

var _gdspx_sprite_set_trigger_rect = Module["_gdspx_sprite_set_trigger_rect"] = createExportWrapper("gdspx_sprite_set_trigger_rect");

var _gdspx_sprite_set_trigger_circle = Module["_gdspx_sprite_set_trigger_circle"] = createExportWrapper("gdspx_sprite_set_trigger_circle");

var _gdspx_sprite_set_trigger_capsule = Module["_gdspx_sprite_set_trigger_capsule"] = createExportWrapper("gdspx_sprite_set_trigger_capsule");

var _gdspx_sprite_set_trigger_enabled = Module["_gdspx_sprite_set_trigger_enabled"] = createExportWrapper("gdspx_sprite_set_trigger_enabled");

var _gdspx_sprite_is_trigger_enabled = Module["_gdspx_sprite_is_trigger_enabled"] = createExportWrapper("gdspx_sprite_is_trigger_enabled");

var _gdspx_ui_bind_node = Module["_gdspx_ui_bind_node"] = createExportWrapper("gdspx_ui_bind_node");

var _gdspx_ui_create_node = Module["_gdspx_ui_create_node"] = createExportWrapper("gdspx_ui_create_node");

var _gdspx_ui_create_button = Module["_gdspx_ui_create_button"] = createExportWrapper("gdspx_ui_create_button");

var _gdspx_ui_create_label = Module["_gdspx_ui_create_label"] = createExportWrapper("gdspx_ui_create_label");

var _gdspx_ui_create_image = Module["_gdspx_ui_create_image"] = createExportWrapper("gdspx_ui_create_image");

var _gdspx_ui_create_toggle = Module["_gdspx_ui_create_toggle"] = createExportWrapper("gdspx_ui_create_toggle");

var _gdspx_ui_create_slider = Module["_gdspx_ui_create_slider"] = createExportWrapper("gdspx_ui_create_slider");

var _gdspx_ui_create_input = Module["_gdspx_ui_create_input"] = createExportWrapper("gdspx_ui_create_input");

var _gdspx_ui_destroy_node = Module["_gdspx_ui_destroy_node"] = createExportWrapper("gdspx_ui_destroy_node");

var _gdspx_ui_get_type = Module["_gdspx_ui_get_type"] = createExportWrapper("gdspx_ui_get_type");

var _gdspx_ui_set_text = Module["_gdspx_ui_set_text"] = createExportWrapper("gdspx_ui_set_text");

var _gdspx_ui_get_text = Module["_gdspx_ui_get_text"] = createExportWrapper("gdspx_ui_get_text");

var _gdspx_ui_set_texture = Module["_gdspx_ui_set_texture"] = createExportWrapper("gdspx_ui_set_texture");

var _gdspx_ui_get_texture = Module["_gdspx_ui_get_texture"] = createExportWrapper("gdspx_ui_get_texture");

var _gdspx_ui_set_color = Module["_gdspx_ui_set_color"] = createExportWrapper("gdspx_ui_set_color");

var _gdspx_ui_get_color = Module["_gdspx_ui_get_color"] = createExportWrapper("gdspx_ui_get_color");

var _gdspx_ui_set_font_size = Module["_gdspx_ui_set_font_size"] = createExportWrapper("gdspx_ui_set_font_size");

var _gdspx_ui_get_font_size = Module["_gdspx_ui_get_font_size"] = createExportWrapper("gdspx_ui_get_font_size");

var _gdspx_ui_set_visible = Module["_gdspx_ui_set_visible"] = createExportWrapper("gdspx_ui_set_visible");

var _gdspx_ui_get_visible = Module["_gdspx_ui_get_visible"] = createExportWrapper("gdspx_ui_get_visible");

var _gdspx_ui_set_interactable = Module["_gdspx_ui_set_interactable"] = createExportWrapper("gdspx_ui_set_interactable");

var _gdspx_ui_get_interactable = Module["_gdspx_ui_get_interactable"] = createExportWrapper("gdspx_ui_get_interactable");

var _gdspx_ui_set_rect = Module["_gdspx_ui_set_rect"] = createExportWrapper("gdspx_ui_set_rect");

var _gdspx_ui_get_rect = Module["_gdspx_ui_get_rect"] = createExportWrapper("gdspx_ui_get_rect");

var _gdspx_ui_get_layout_direction = Module["_gdspx_ui_get_layout_direction"] = createExportWrapper("gdspx_ui_get_layout_direction");

var _gdspx_ui_set_layout_direction = Module["_gdspx_ui_set_layout_direction"] = createExportWrapper("gdspx_ui_set_layout_direction");

var _gdspx_ui_get_layout_mode = Module["_gdspx_ui_get_layout_mode"] = createExportWrapper("gdspx_ui_get_layout_mode");

var _gdspx_ui_set_layout_mode = Module["_gdspx_ui_set_layout_mode"] = createExportWrapper("gdspx_ui_set_layout_mode");

var _gdspx_ui_get_anchors_preset = Module["_gdspx_ui_get_anchors_preset"] = createExportWrapper("gdspx_ui_get_anchors_preset");

var _gdspx_ui_set_anchors_preset = Module["_gdspx_ui_set_anchors_preset"] = createExportWrapper("gdspx_ui_set_anchors_preset");

var _gdspx_ui_get_scale = Module["_gdspx_ui_get_scale"] = createExportWrapper("gdspx_ui_get_scale");

var _gdspx_ui_set_scale = Module["_gdspx_ui_set_scale"] = createExportWrapper("gdspx_ui_set_scale");

var _gdspx_ui_get_position = Module["_gdspx_ui_get_position"] = createExportWrapper("gdspx_ui_get_position");

var _gdspx_ui_set_position = Module["_gdspx_ui_set_position"] = createExportWrapper("gdspx_ui_set_position");

var _gdspx_ui_get_size = Module["_gdspx_ui_get_size"] = createExportWrapper("gdspx_ui_get_size");

var _gdspx_ui_set_size = Module["_gdspx_ui_set_size"] = createExportWrapper("gdspx_ui_set_size");

var _gdspx_ui_get_global_position = Module["_gdspx_ui_get_global_position"] = createExportWrapper("gdspx_ui_get_global_position");

var _gdspx_ui_set_global_position = Module["_gdspx_ui_set_global_position"] = createExportWrapper("gdspx_ui_set_global_position");

var _gdspx_ui_get_rotation = Module["_gdspx_ui_get_rotation"] = createExportWrapper("gdspx_ui_get_rotation");

var _gdspx_ui_set_rotation = Module["_gdspx_ui_set_rotation"] = createExportWrapper("gdspx_ui_set_rotation");

var _gdspx_ui_get_flip = Module["_gdspx_ui_get_flip"] = createExportWrapper("gdspx_ui_get_flip");

var _gdspx_ui_set_flip = Module["_gdspx_ui_set_flip"] = createExportWrapper("gdspx_ui_set_flip");

var _gdspx_get_value = Module["_gdspx_get_value"] = createExportWrapper("gdspx_get_value");

var _gdspx_alloc_bool = Module["_gdspx_alloc_bool"] = createExportWrapper("gdspx_alloc_bool");

var _gdspx_new_bool = Module["_gdspx_new_bool"] = createExportWrapper("gdspx_new_bool");

var _gdspx_free_bool = Module["_gdspx_free_bool"] = createExportWrapper("gdspx_free_bool");

var _gdspx_alloc_float = Module["_gdspx_alloc_float"] = createExportWrapper("gdspx_alloc_float");

var _gdspx_new_float = Module["_gdspx_new_float"] = createExportWrapper("gdspx_new_float");

var _gdspx_free_float = Module["_gdspx_free_float"] = createExportWrapper("gdspx_free_float");

var _gdspx_alloc_int = Module["_gdspx_alloc_int"] = createExportWrapper("gdspx_alloc_int");

var _gdspx_new_int = Module["_gdspx_new_int"] = createExportWrapper("gdspx_new_int");

var _gdspx_free_int = Module["_gdspx_free_int"] = createExportWrapper("gdspx_free_int");

var _gdspx_alloc_obj = Module["_gdspx_alloc_obj"] = createExportWrapper("gdspx_alloc_obj");

var _gdspx_new_obj = Module["_gdspx_new_obj"] = createExportWrapper("gdspx_new_obj");

var _gdspx_free_obj = Module["_gdspx_free_obj"] = createExportWrapper("gdspx_free_obj");

var _gdspx_alloc_vec2 = Module["_gdspx_alloc_vec2"] = createExportWrapper("gdspx_alloc_vec2");

var _gdspx_new_vec2 = Module["_gdspx_new_vec2"] = createExportWrapper("gdspx_new_vec2");

var _gdspx_free_vec2 = Module["_gdspx_free_vec2"] = createExportWrapper("gdspx_free_vec2");

var _gdspx_alloc_vec3 = Module["_gdspx_alloc_vec3"] = createExportWrapper("gdspx_alloc_vec3");

var _gdspx_new_vec3 = Module["_gdspx_new_vec3"] = createExportWrapper("gdspx_new_vec3");

var _gdspx_free_vec3 = Module["_gdspx_free_vec3"] = createExportWrapper("gdspx_free_vec3");

var _gdspx_alloc_vec4 = Module["_gdspx_alloc_vec4"] = createExportWrapper("gdspx_alloc_vec4");

var _gdspx_new_vec4 = Module["_gdspx_new_vec4"] = createExportWrapper("gdspx_new_vec4");

var _gdspx_free_vec4 = Module["_gdspx_free_vec4"] = createExportWrapper("gdspx_free_vec4");

var _gdspx_alloc_color = Module["_gdspx_alloc_color"] = createExportWrapper("gdspx_alloc_color");

var _gdspx_new_color = Module["_gdspx_new_color"] = createExportWrapper("gdspx_new_color");

var _gdspx_free_color = Module["_gdspx_free_color"] = createExportWrapper("gdspx_free_color");

var _gdspx_alloc_rect2 = Module["_gdspx_alloc_rect2"] = createExportWrapper("gdspx_alloc_rect2");

var _gdspx_new_rect2 = Module["_gdspx_new_rect2"] = createExportWrapper("gdspx_new_rect2");

var _gdspx_free_rect2 = Module["_gdspx_free_rect2"] = createExportWrapper("gdspx_free_rect2");

var _gdspx_alloc_string = Module["_gdspx_alloc_string"] = createExportWrapper("gdspx_alloc_string");

var _gdspx_new_string = Module["_gdspx_new_string"] = createExportWrapper("gdspx_new_string");

var _gdspx_get_string = Module["_gdspx_get_string"] = createExportWrapper("gdspx_get_string");

var _malloc = createExportWrapper("malloc");

var _gdspx_free_cstr = Module["_gdspx_free_cstr"] = createExportWrapper("gdspx_free_cstr");

var _gdspx_get_string_len = Module["_gdspx_get_string_len"] = createExportWrapper("gdspx_get_string_len");

var _gdspx_free_string = Module["_gdspx_free_string"] = createExportWrapper("gdspx_free_string");
...
var dynCall_vjif = Module["dynCall_vjif"] = createExportWrapper("dynCall_vjif");

var dynCall_vjjiii = Module["dynCall_vjjiii"] = createExportWrapper("dynCall_vjjiii");

var dynCall_vjf = Module["dynCall_vjf"] = createExportWrapper("dynCall_vjf");

var dynCall_vjifi = Module["dynCall_vjifi"] = createExportWrapper("dynCall_vjifi");

  ...
  <section class="copilot-round">
    ...
    <div v-else class="abnormal">
      <div v-if="round.state === RoundState.Loading" class="loading">
        ...
        >
          <circle cx="4.99668" cy="9.99668" r="1.66667" fill="#36C2CF" />
          <circle opacity="0.5" cx="9.99668" cy="9.99668" r="1.66667" fill="#36C2CF" />
          <circle cx="14.9967" cy="9.99668" r="1.66667" fill="#36C2CF" />
        </svg>

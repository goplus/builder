...
import RenameModal from '@/components/editor/panels/common/RenameModal.vue'
import RenameModalFooter from '@/components/editor/panels/common/RenameModalFooter.vue'

<template>
  ...
  <UICard
    ...
    :class="isPreviewFocused ? 'flex-[3.5_1_0]' : 'flex-[1_1_0]'"
  >
    <!--
  ...
  <div
    ...
    :class="isPreviewFocused ? 'flex-[3_1_0] min-w-[660px]' : 'flex-[0_0_496px]'"
  >
    <EditorPreview :fill-container="isPreviewFocused" />
    <EditorPanels v-if="!isPreviewFocused" />
  </div>
  <MapEditor
    v-if="!isPreviewMode"
...
const props = withDefaults(
  defineProps<{
    layout?: 'default' | 'preview-focused'
  }>(),
  { layout: 'default' }
)
...
const isPreviewFocused = computed(() => props.layout === 'preview-focused')

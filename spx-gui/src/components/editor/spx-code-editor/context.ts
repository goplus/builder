...
import { loadMonaco, CodeEditor, DocumentBase, useProvideCodeEditor } from '@/components/xgo-code-editor'
...
export { useCodeEditor, useCodeEditorRef } from '@/components/xgo-code-editor'

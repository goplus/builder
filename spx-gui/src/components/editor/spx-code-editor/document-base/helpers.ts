...
import { xgoDefinitions, type DefinitionDocumentationItem } from '@/components/xgo-code-editor'
import { keys as spxKeyDefinitions } from './key'
import * as spxDefinitions from '.'

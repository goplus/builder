...
const apiReferenceItems = [
  ...
  `xgo:${packageSpx}?Sprite.onCloned#1`,
  `xgo:${packageSpx}?Sprite.onTouchStart#1`,
  `xgo:${packageSpx}?Sprite.onTouchStart#3`,

...
<template>
  <div class="wrapper">
    ...
    <div class="line">
      <p class="with-label">
        {{ $t({ en: 'Physics Mode', zh: '物理模式' }) }}:
        <UIButtonGroup
          v-radar="{ name: 'Physics mode control', desc: 'Control to set sprite physics mode' }"
          :value="'none'"
          type="text"
        >
          <UIButtonGroupItem :value="'none'">
            {{ $t({ en: 'None', zh: '无' }) }}
          </UIButtonGroupItem>
          <UIButtonGroupItem :value="'static'">
            {{ $t({ en: 'Static', zh: '静态' }) }}
          </UIButtonGroupItem>
          <UIButtonGroupItem :value="'kinematic'">
            {{ $t({ en: 'Kinematic', zh: '碰撞' }) }}
          </UIButtonGroupItem>
          <UIButtonGroupItem :value="'dynamic'">
            {{ $t({ en: 'Dynamic', zh: '重力+碰撞' }) }}
          </UIButtonGroupItem>
        </UIButtonGroup>
      </p>
    </div>

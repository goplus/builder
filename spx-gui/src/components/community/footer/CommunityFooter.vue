...
<template>
  <footer
    v-if="showLicense"
    class="h-12.5 w-full flex-none flex items-center justify-center gap-6 text-xs text-grey-700"
  >
    ...
    >
      <img class="mr-1 h-4 w-4" src="./license-icon.png" />沪公网安备 31011502000961 号
    </UILink>
    <UILink
      class="flex items-center justify-center no-underline"
      type="boring"

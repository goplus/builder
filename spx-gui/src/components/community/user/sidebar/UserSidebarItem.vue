...
<template>
  ...
  >
    ...
    />
    <span
      class="relative flex-[1_1_0] pl-6.5 text-sm [&_svg]:absolute [&_svg]:left-0 [&_svg]:top-1/2 [&_svg]:z-1 [&_svg]:-translate-y-1/2 [&_svg]:text-grey-800 group-[.active]:[&_svg]:text-primary-main"
    >
      <slot></slot>
    </span>

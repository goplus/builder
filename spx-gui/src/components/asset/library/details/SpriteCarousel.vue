...
import { Renderer } from '@/components/asset/animation/skeleton/SkeletonAnimationRenderer.vue'
import type { SkeletonClip } from '@/models/skeletonAnimation'
import SkeletonAnimationPlayer from '@/components/asset/animation/skeleton/SkeletonAnimationPlayer.vue'
...
watch(
  () => props.sprite.skeletonAnimation,
  () => {

<template>
  <div class="sprite-generator">
    ...
    <AnimationGenerator
      v-else-if="editingAnimationIndex != null"
      :sprite="sprite"
          ...
          <div class="content-section">
            ...
            <div class="content-list">
              ...
              <div
                ...
                :title="!canGenerateAnimation ? $t({ en: 'Generate default costume first', zh: '请先生成默认造型' }) : ''"
...
const emit = defineEmits<{
  ...
  hide: [state: SpriteGeneratorState]
}>()
...
function handleHide() {
  const state: SpriteGeneratorState = {
    stage: stage.value,
    brief: brief.value,

<template>
  <div class="costume-generator">
    ...
    <div v-if="stage === 'input-brief' || stage === 'enriching'" class="settings-section settings-section--centered">
      ...
      <div class="form-row">
        <div class="form-row-actions">
          <UIButton v-if="stage === 'input-brief'" type="primary" size="medium" @click="handleSubmitBrief">
            {{ $t({ en: 'Next', zh: '下一步' }) }}
          </UIButton>
        </div>
      </div>
      ...
      <div v-if="showModificationForm && stage === 'preview'" class="modification-form-overlay">
        <div class="modification-form">
          ...
          <div class="modification-actions">
            ...
            <UIButton type="primary" size="medium" :disabled="!modificationInstruction.trim()" @click="submitModification">
              {{ $t({ en: 'Submit', zh: '提交' }) }}
            </UIButton>
          </div>
        </div>

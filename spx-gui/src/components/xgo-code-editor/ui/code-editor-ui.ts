...
export const builtInCommandCopilotInspire: Command<[problem: string], void> = 'xgo.copilot.inspire'
export const builtInCommandCopilotExplain: Command<[target: CopilotExplainTarget], void> = 'xgo.copilot.explain'
export const builtInCommandCopilotReview: Command<[target: CopilotReviewTarget], void> = 'xgo.copilot.review'
export const builtInCommandCopilotFixProblem: Command<[target: CopilotFixProblemTarget], void> =
  'xgo.copilot.fixProblem'
...
export class CodeEditorUIController extends Disposable implements ICodeEditorUIController {
  ...
  get project() {
    return this.codeEditor.project
  }
  get monaco() {
    return this.codeEditor.monaco
  }
  ...
  get activeTextDocument() {
    ...
    return this.codeEditor.getTextDocument(this.activeTextDocumentIdRef.value)
  }
  ...
  private setActiveTextDocument(activeId: TextDocumentIdentifier | null) {
    const textDocument = activeId != null ? this.codeEditor.getTextDocument(activeId) : null
  ...
  private registerCopilotCommands(copilot: ICopilot) {
    ...
    this.registerCommand(builtInCommandCopilotExplain, {
      ...
      handler: (target) => {
        ...
        copilot.addUserTextMessage(this.i18n.t(message), {
          title: { en: 'Explain', zh: '解释' },
          description: '',
          reactToEvents: false
        })
    ...
    this.registerCommand(builtInCommandCopilotReview, {
      ...
      handler: ({ textDocument, range, code }) => {
        ...
        copilot.addUserTextMessage(message, {
          title: { en: 'Review', zh: '审查' },
          description: '',
          reactToEvents: false
        })
  ...
  init(editor: MonacoEditor) {
    ...
    if (this.codeEditor.copilot != null) this.registerCopilotCommands(this.codeEditor.copilot)

  ...
  >
    ...
    <template v-else>
      ...
      <ul
        ...
        :class="{ 'overflow-x-auto pt-3': blockStyle }"
      >
        <li
        ...
        >
          <section
            ...
            :key="sc.id"
            :class="{ 'border-b border-dashed border-grey-500': !blockStyle }"
          >
            <h5 v-if="!blockStyle" class="sticky top-0 z-10 bg-grey-100 py-3 text-xs text-hint-2">
              {{ $t(sc.label) }}
            </h5>

...
<template>
  <button
    class="fixed -ml-5 flex cursor-pointer border-0 bg-grey-100 p-0 text-yellow-main opacity-80 outline-none transition-all hover:text-yellow-600 hover:opacity-100"
    type="button"
    @click="handleClick"
  >

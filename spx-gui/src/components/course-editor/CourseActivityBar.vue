 ...
 * carries a dot. It is a card like the view beside it, square on the left where it meets the window's edge. It holds
 * no state: what is open and what is unsaved come in as props, and a click is reported to the parent, which
 * navigates.
 *
 * Props:
 ...
 *   (`@select="openView"`).
 *
 * Used by: `components/course-editor/CourseEditor.vue#template` (first in the main area's row, not while previewing).
 *
 * Uses: UICard, UIIcon, UITooltip, `course-views.ts#courseViews` / `#getViewIcon` / `#getViewLabel`.
 */

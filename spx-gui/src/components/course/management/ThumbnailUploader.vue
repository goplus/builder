...
<template>
  <div
    class="flex cursor-pointer items-center justify-center overflow-hidden rounded-2 border border-dashed border-grey-400 transition-[border-color,background-color] duration-300 hover:border-primary-main hover:bg-grey-400"

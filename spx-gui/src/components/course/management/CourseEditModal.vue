...
watch(
  ...
  (newCourse) => {
    if (newCourse) {
      form.value.title = newCourse.title
      form.value.entrypoint = newCourse.entrypoint
      form.value.thumbnail = newCourse.thumbnail || ''
      form.value.references = newCourse.references || []
      form.value.prompt = newCourse.prompt
    } else {
      form.value.title = ''
      ...
      <div class="form-grid">
        <div class="form-column">
          ...
          <UIFormItem path="thumbnail" :label="$t({ en: 'Thumbnail', zh: '缩略图' })">
            <ThumbnailUploader v-model="form.value.thumbnail" />
          </UIFormItem>
        </div>
        ...
        <div class="form-column">
          ...
          <UIFormItem path="references" :label="$t({ en: 'Reference projects', zh: '参考项目' })">
            <ProjectReferencesInput v-model="form.value.references" />
          </UIFormItem>
        </div>
      </div>

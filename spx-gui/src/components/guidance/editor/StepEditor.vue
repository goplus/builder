          ...
          <div class="node-task-item-content">
            ...
            <UIFormItem :label="$t({ zh: '控制api', en: 'Control api' })">
              <div class="form-item-wrap">
                ...
                <div v-if="form.value.step.isApiControl" class="form-item-content">
                  <div v-for="(item, index) in form.value.step.apis" :key="item" class="content-header">
                    <UITextInput
                      v-model:value="form.value.step.apis[index]"
                      :placeholder="t({ zh: '请输入api', en: 'Please input an api' })"
                    />
                    <UIButton
                      type="danger"
                      icon="trash"
            ...
            <UIFormItem :label="$t({ zh: '控制素材', en: 'Control asset' })">
              <div class="form-item-wrap">
                ...
                <div v-if="form.value.step.isAssetControl" class="form-item-content">
                  <div v-for="(item, index) in form.value.step.assets" :key="item" class="content-header">
                    <UITextInput
                      v-model:value="form.value.step.assets[index]"
                      :placeholder="t({ zh: '请输入素材名称', en: 'Please input the name of an asset' })"
                    />
                    <UIButton
                      type="danger"
                      icon="trash"
            ...
            <UIFormItem :label="$t({ zh: '控制精灵', en: 'Control sprite' })">
              <div class="form-item-wrap">
                ...
                <div v-if="form.value.step.isSpriteControl" class="form-item-content">
                  <div v-for="(item, index) in form.value.step.sprites" :key="item" class="content-header">
                    <UITextInput
                      v-model:value="form.value.step.sprites[index]"
                      :placeholder="t({ zh: '请输入精灵名称', en: 'Please input the name of a sprite' })"
                    />
                    <UIButton
                      type="danger"
                      icon="trash"
            ...
            <UIFormItem :label="$t({ zh: '控制声音', en: 'Control sound' })">
              <div class="form-item-wrap">
                ...
                <div v-if="form.value.step.isSoundControl" class="form-item-content">
                  <div v-for="(item, index) in form.value.step.sounds" :key="item" class="content-header">
                    <UITextInput
                      v-model:value="form.value.step.sounds[index]"
                      :placeholder="t({ zh: '请输入声音文件名称', en: 'Please input the name of a sound file' })"
                    />
                    <UIButton
                      type="danger"
                      icon="trash"
            ...
            <UIFormItem :label="$t({ zh: '控制舞台', en: 'Control backdrop' })">
              <div class="form-item-wrap">
                ...
                <div v-if="form.value.step.isBackdropControl" class="form-item-content">
                  <div v-for="(item, index) in form.value.step.backdrops" :key="item" class="content-header">
                    <UITextInput
                      v-model:value="form.value.step.backdrops[index]"
                      :placeholder="t({ zh: '请输入舞台名称', en: 'Please input the name of a backdrop' })"
                    />
                    <UIButton
                      type="danger"
                      icon="trash"
            ...
            <UIFormItem :label="$t({ zh: '控制造型', en: 'Control costume' })">
              <div class="form-item-wrap">
                ...
                <div v-if="form.value.step.isCostumeControl" class="form-item-content">
                  <div v-for="(item, index) in form.value.step.costumes" :key="item" class="content-header">
                    <UITextInput
                      v-model:value="form.value.step.costumes[index]"
                      :placeholder="t({ zh: '请输入造型名称', en: 'Please input the name of a costume' })"
                    />
                    <UIButton
                      type="danger"
                      icon="trash"
            ...
            <UIFormItem :label="$t({ zh: '控制动画', en: 'Control animation' })">
              <div class="form-item-wrap">
                ...
                <div v-if="form.value.step.isAnimationControl" class="form-item-content">
                  <div v-for="(item, index) in form.value.step.animations" :key="item" class="content-header">
                    <UITextInput
                      v-model:value="form.value.step.animations[index]"
                      :placeholder="t({ zh: '请输入动画名称', en: 'Please input name of an animation' })"
                    />
                    <UIButton
                      type="danger"
                      icon="trash"
            ...
            <UIFormItem :label="$t({ zh: '控制组件', en: 'Control widget' })">
              <div class="form-item-wrap">
                ...
                <div v-if="form.value.step.isWidgetControl" class="form-item-content">
                  <div v-for="(item, index) in form.value.step.widgets" :key="item" class="content-header">
                    <UITextInput
                      v-model:value="form.value.step.widgets[index]"
                      :placeholder="t({ zh: '请输入声音文件名称', en: 'Please input name of a widget' })"
                    />
                    <UIButton
                      type="danger"
                      icon="trash"
            ...
            >
              <UITextInput
                :value="form.value.step.snapshot.endSnapshot || ''"
                readonly
                type="textarea"
                style="width: 600px"
              />
            ...
            <div v-if="form.value.step.coding && form.value.step.type === 'coding'" style="margin-top: 20px">
              ...
              <UIFormItem :label="$t({ zh: '答案代码块开始坐标', en: 'Start position of answer' })">
                <div>
                  line:
                  <UINumberInput
                    v-model:value="form.value.step.coding.startPosition.line"
                    placeholder="请输入代码块开始坐标行"
                  />
                </div>
                <div style="margin-left: 20px">
                  column:
                  <UINumberInput
                    v-model:value="form.value.step.coding.startPosition.column"
                    placeholder="请输入代码块开始坐标列"
                  />
                </div>
              </UIFormItem>
              <UIFormItem :label="$t({ zh: '答案代码块结束坐标', en: 'End position of answer' })">
                <div>
                  line:
                  <UINumberInput
                    v-model:value="form.value.step.coding.endPosition.line"
                    placeholder="请输入代码块结束坐标行"
                  />
                </div>
                <div style="margin-left: 20px">
                  column:
                  <UINumberInput
                    v-model:value="form.value.step.coding.endPosition.column"
                    placeholder="请输入代码块结束坐标列"
                  />
                </div>
              </UIFormItem>
            </div>
...
function handleControlContent(type: string) {
  switch (type) {
    case 'api':
      form.value.step.apis.push('')
      break
    case 'sound':
      form.value.step.sounds.push('')
      break
    case 'animation':
      form.value.step.animations.push('')
      break
    case 'backdrop':
      form.value.step.backdrops.push('')
      break
    case 'costume':
      form.value.step.costumes.push('')
      break
    case 'sprite':
      form.value.step.sprites.push('')
      break
    case 'widget':

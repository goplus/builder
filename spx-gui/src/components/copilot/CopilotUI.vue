...
<template>
  ...
  >
    <span class="docked-copilot-face">
      <svg
...
/* Docked trigger: a white card framing the brand gradient square, mirroring the Run control. */
...
.docked-copilot-trigger:hover .docked-copilot-face,
.docked-copilot-trigger.active .docked-copilot-face {

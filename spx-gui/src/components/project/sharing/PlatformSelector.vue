...
const handlePlatformChange = (platform: PlatformConfig) => {
  ...
  emit('update:model-value', platform)
}
...
onMounted(() => {
  emit('update:model-value', selectedPlatform.value)
})
    ...
    <div class="social-icons">
      ...
      >
        <div class="icon-wrapper">
          <img v-if="platform.basicInfo.name === 'qq'" :src="qqIcon" class="icon" alt="QQ" />
          <img v-else-if="platform.basicInfo.name === 'wechat'" :src="wechatIcon" class="icon" alt="WeChat" />
          <img v-else-if="platform.basicInfo.name === 'douyin'" :src="douyinIcon" class="icon" alt="Douyin" />
          <img
            ...
            alt="Xiaohongshu"
          />
          <img v-else-if="platform.basicInfo.name === 'bilibili'" :src="bilibiliIcon" class="icon" alt="Bilibili" />
        </div>

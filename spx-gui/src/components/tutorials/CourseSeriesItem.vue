...
<template>
  <li
    ...
    class="relative h-53.5 w-58 overflow-hidden rounded-3 transition-all duration-200 hover:cursor-pointer hover:-translate-y-0.5 hover:shadow-[0_4px_12px_rgba(0,0,0,0.3)]"
  ...
  >
    <RouterLink :to="`/course-series/${props.courseSeries.id}`">
      ...
      <div
        class="absolute bottom-0 h-10 w-full overflow-hidden whitespace-nowrap px-4 text-15 leading-10 text-grey-100 text-ellipsis"

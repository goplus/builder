...
<template>
  <div class="user-overview">
    ...
    <CommunityCard class="card">
      <ProjectsSection
        v-radar="{ name: 'User recordings', desc: 'Section showing user\'s recordings' }"
        context="user"
        :num-in-row="numInRow"
        :query-ret="recordingsRet"
        :link-to="recordingsRoute"
      ...
      >
        ...
        <RecordingItem
          v-for="recording in recordingsRet.data.value"
          :key="recording.id"
          context="mine"
          :recording="recording"

  ...
  <UserContent class="user-likes" :style="{ '--project-num-in-row': numInRow }">
    ...
    <div class="section">
      ...
      <div class="projects-wrapper">
        ...
        <UIPagination
v-show="projectsPageTotal > 1" v-model:current="page" class="pagination"
    ...
    <div class="section">
      ...
      <div class="recordings-wrapper">
        <ListResultWrapper v-slot="slotProps" content-type="recording" :query-ret="recordingsQueryRet" :height="350">
          <ul class="recordings">
            <RecordingItem v-for="recording in slotProps.data.data" :key="recording.id" context="public" :recording="recording" />
          </ul>
        </ListResultWrapper>
      </div>
    </div>

  ...
  ref="videoRef" :src="videoUrl || ''" :poster="thumbnailUrl || ''" controls preload="metadata"
          ...
          <div ref="infoSideRef" class="info-side">
            ...
            <div class="action-buttons">
              <UIButton
v-if="recording.projectFullName" type="primary" size="large"
...
type="secondary" size="medium" :class="{ liking }" :loading="isTogglingLike"
      ...
      <div v-if="recording.projectFullName" class="related-content-frame">
        <ProjectsSection
context="project" :num-in-row="numInRow" :query-ret="relatedRecordingsQuery"
          ...
          <RecordingItem
v-for="relatedRecording in relatedRecordingsQuery.data.value" :key="relatedRecording.id"
...
import { getRecording, recordRecordingView, listRecording, likeRecording, unlikeRecording, isLikingRecording } from '@/apis/recording'

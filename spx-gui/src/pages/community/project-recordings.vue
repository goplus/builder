<template>
  <CenteredWrapper class="project-recordings-page">
    ...
    <div class="recordings-section" :style="{ '--recordings-per-row': numInRow }">
      <ListResultWrapper v-slot="slotProps" content-type="recording" :query-ret="recordingsQueryRet" :height="600">
    ...
    <!-- 分页 -->
    <UIPagination v-if="pageTotal > 1" v-model:current="page" class="pagination" :total="pageTotal" />
  </CenteredWrapper>
</template>

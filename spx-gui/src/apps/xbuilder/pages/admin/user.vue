        ...
        <div class="flex min-w-0 items-center gap-4">
          ...
          <div class="min-w-0">
            ...
            <div class="mt-0.5 flex min-w-0 items-center gap-1 text-sm text-grey-800">
              ...
              <UICopyButton :value="user.username" :label="{ en: 'Copy username', zh: '复制用户名' }" />
            </div>
            <div class="mt-1 flex items-center gap-1 font-mono text-xs text-grey-700">
              <span>ID {{ user.id }}</span>
              <UICopyButton :value="user.id" :label="{ en: 'Copy user ID', zh: '复制用户 ID' }" />
            </div>
          </div>
        </div>
        <UIButton
              ...
              >
                <div class="min-w-0 text-sm">
                  ...
                  <div class="mt-1 flex items-center gap-1 font-mono text-xs text-grey-700">
                    ...
                    <UICopyButton :value="identity.id" :label="{ en: 'Copy identity ID', zh: '复制第三方身份 ID' }" />
                  </div>
                  <div class="mt-1 text-xs text-grey-700">
              ...
              >
                <td class="px-4 py-3 font-mono text-xs text-grey-700">
                  <div class="flex items-center gap-1">
                    ...
                    <UICopyButton :value="session.id" :label="{ en: 'Copy session ID', zh: '复制会话 ID' }" />
                  </div>
                </td>
...
import {
  accountAdminRoleLabels,
  accountAdminRoles,
  accountIdentityProviderLabels,
  formatJSON,
  formatTime,
  type AccountAdminRole
} from './common'

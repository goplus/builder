...
type post_aigc_image_sync struct {
	yap.Handler
	*AppV2
}
...
//line cmd/spx-backend/get_user_history_list.yap:31:1
		if err != nil {
//line cmd/spx-backend/get_user_history_list.yap:32:1
			replyWithCode(ctx, errorInvalidArgs)
...
//line cmd/spx-backend/get_user_history_list.yap:35:1
		assetType := model.AssetType(assetTypeInt)
//line cmd/spx-backend/get_user_history_list.yap:36:1
		params.AssetType = &assetType
	}
...
//line cmd/spx-backend/get_user_history_list.yap:44:1
	params.Pagination.Size = ctx.ParamInt("pageSize", defaultPageSize)
//line cmd/spx-backend/get_user_history_list.yap:46:1
...
//line cmd/spx-backend/get_user_history_list.yap:48:1
		replyWithInnerError(ctx, err)
//line cmd/spx-backend/get_user_history_list.yap:49:1
		return
	}
...
//line cmd/spx-backend/get_user_liked_list.yap:30:1
		assetTypeInt, err := strconv.Atoi(assetTypeParam)
//line cmd/spx-backend/get_user_liked_list.yap:31:1
		if err != nil {
//line cmd/spx-backend/get_user_liked_list.yap:32:1
			replyWithCode(ctx, errorInvalidArgs)
//line cmd/spx-backend/get_user_liked_list.yap:33:1
			return
		}
//line cmd/spx-backend/get_user_liked_list.yap:35:1
		assetType := model.AssetType(assetTypeInt)
...
//line cmd/spx-backend/get_user_liked_list.yap:44:1
	params.Pagination.Size = ctx.ParamInt("pageSize", defaultPageSize)
//line cmd/spx-backend/get_user_liked_list.yap:46:1
...
//line cmd/spx-backend/get_user_liked_list.yap:48:1
		replyWithInnerError(ctx, err)
//line cmd/spx-backend/get_user_liked_list.yap:49:1
		return
	}
...
//line cmd/spx-backend/post_aigc_animate.yap:10
func (this *post_aigc_animate) Main(_gop_arg0 *yap.Context) {
	this.Handler.Main(_gop_arg0)
//line cmd/spx-backend/post_aigc_animate.yap:10:1
	ctx := &this.Context
//line cmd/spx-backend/post_aigc_animate.yap:12:1
	_, ok := ensureUser(ctx)
//line cmd/spx-backend/post_aigc_animate.yap:13:1
	if !ok {
...
//line cmd/spx-backend/post_aigc_image_sync.yap:10
func (this *post_aigc_image_sync) Main(_gop_arg0 *yap.Context) {
	this.Handler.Main(_gop_arg0)
//line cmd/spx-backend/post_aigc_image_sync.yap:10:1
	ctx := &this.Context
//line cmd/spx-backend/post_aigc_image_sync.yap:12:1
	_, ok := ensureUser(ctx)
//line cmd/spx-backend/post_aigc_image_sync.yap:13:1
	if !ok {
//line cmd/spx-backend/post_aigc_image_sync.yap:14:1
		return
	}
//line cmd/spx-backend/post_aigc_image_sync.yap:17:1
	params := &controller.GenerateParams{}
//line cmd/spx-backend/post_aigc_image_sync.yap:18:1
	if !parseJSON(ctx, params) {
//line cmd/spx-backend/post_aigc_image_sync.yap:19:1
		return
	}
//line cmd/spx-backend/post_aigc_image_sync.yap:21:1
	result, err := this.ctrl.GeneratingSync(ctx.Context(), params)
//line cmd/spx-backend/post_aigc_image_sync.yap:23:1
	if err != nil {
//line cmd/spx-backend/post_aigc_image_sync.yap:24:1
		replyWithInnerError(ctx, err)
//line cmd/spx-backend/post_aigc_image_sync.yap:25:1
		return
	}
//line cmd/spx-backend/post_aigc_image_sync.yap:27:1
	this.Json__1(result)
}
...
//line cmd/spx-backend/post_aigc_motion.yap:10
func (this *post_aigc_motion) Main(_gop_arg0 *yap.Context) {
	this.Handler.Main(_gop_arg0)
//line cmd/spx-backend/post_aigc_motion.yap:10:1
	ctx := &this.Context
//line cmd/spx-backend/post_aigc_motion.yap:12:1
	_, ok := ensureUser(ctx)
//line cmd/spx-backend/post_aigc_motion.yap:13:1
	if !ok {
//line cmd/spx-backend/post_aigc_motion.yap:14:1
		return
	}
//line cmd/spx-backend/post_aigc_motion.yap:17:1
	params := &controller.ExtractMotionParams{}
//line cmd/spx-backend/post_aigc_motion.yap:18:1
	if !parseJSON(ctx, params) {
//line cmd/spx-backend/post_aigc_motion.yap:19:1
		return
	}
//line cmd/spx-backend/post_aigc_motion.yap:21:1
	result, err := this.ctrl.ExtractMotion(ctx.Context(), params)
//line cmd/spx-backend/post_aigc_motion.yap:23:1
	if err != nil {
//line cmd/spx-backend/post_aigc_motion.yap:24:1
		replyWithInnerError(ctx, err)
//line cmd/spx-backend/post_aigc_motion.yap:25:1
		return
	}
//line cmd/spx-backend/post_aigc_motion.yap:27:1
	this.Json__1(result)
}
func (this *post_aigc_motion) Classfname() string {
	return "post_aigc_motion"
}

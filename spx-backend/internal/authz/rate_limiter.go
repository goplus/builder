...
type RateLimiter interface {
	// Allow reports whether the user can access the resource given the
	// provided policy. When denied, it returns the remaining cooldown
	// before retry in the second return value.

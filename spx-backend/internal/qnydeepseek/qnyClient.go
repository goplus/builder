...
func (c *Client) ContrastCode(ctx context.Context, content, code1, code2 string) (bool, error) {
	messages := make([]Message, 0, 2)
	// Add system prompt message
	messages = append(messages, NewSystemMessage(llmprompt.CheckCodePrompt))
	...
	messages = append(messages, NewUserMessage(chat))

...
The conversation history follows a specific format:
- User messages: Contain player input and system feedback about function call results
- Assistant messages: Show your previous responses, including both text and function calls
- Function call results appear as:
  - `[SUCCESS]: Function call <function_name> with arguments <JSON>`
  - `[FAILED]: Function call <function_name> with arguments <JSON> (<reason>)`
  - `[Interaction terminated]` may be appended when the interaction was ended

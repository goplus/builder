...
Text you write before a function call is internal planning that is never delivered to players. Use it only when the next
action needs justification. Otherwise, proceed straight to the function call.
...
2. You write brief internal reasoning such as "Enemy mage low HP, use Fireball"

...
- **Built-in MySQL locking**: Uses
  ...
  concurrent safety.
- **Version tracking**: Maintains migration history in a `schema_migrations` table.
...
func (m *Migrator) Migrate() error {
    ...
    // Create migrator with embedded source.
    migrate, err := migrate.NewWithSourceInstance("iofs", sourceDriver, m.dsn)
    if err != nil {

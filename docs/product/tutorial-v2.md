...
* **Messaging**: show text to the learner in a dialog (Markdown supported), play a video, or spotlight a UI element with a hint; each step can wait for the learner's confirmation or advance automatically

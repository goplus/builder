...
它用于在 Design PR 阶段表达产品功能、页面结构、设计样式和基础交互。具体维护规则见 [Prototype Agent Instructions](prototype/AGENTS.md)。
...
| [Prototype Agent Instructions](prototype/AGENTS.md) | `ui/prototype` 维护规则 |

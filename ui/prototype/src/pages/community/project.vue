...
<template>
  <main class="bg-grey-300">
    <CenteredWrapper class="pt-6 pb-10" size="large">
      <UICard class="flex gap-10 bg-grey-100 p-5">
        <section class="min-w-0 flex-[1_1_744px]">
          <div class="aspect-[4/3] overflow-hidden rounded-md bg-grey-1000">
            <ProjectRunner :project="project" :show-controls="false" />
          </div>
          <div class="mt-3 flex justify-end gap-3">
            <UIButton class="!size-8 !p-0" aria-label="Share project" @click="copyShareLink">
        ...
        <aside class="flex min-w-0 flex-[1_1_456px] flex-col pr-5">
          ...
          <div class="mt-4 flex gap-3">
            ...
            >
              <UIButton class="w-full" type="primary" size="large">
            ...
            <UIButton class="flex-[1_1_0]" type="secondary" size="large" @click="copyShareLink">

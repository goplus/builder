...
import EditorPlaceholder from '@/components/editor/common/placeholder/EditorPlaceholder.vue'
import { useEditorCtx } from '@/components/editor/EditorContextProvider.vue'
import { EditMode } from '@/components/editor/editor-state'
import MapEditor from '@/components/editor/map-editor/MapEditor.vue'
import { useSpxEditorCopilot } from '@/components/editor/copilot'

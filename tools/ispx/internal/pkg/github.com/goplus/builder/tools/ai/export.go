...
func init() {
	ixgo.RegisterPackage(&ixgo.Package{
		...
		NamedTypes: map[string]reflect.Type{
			...
			"ClientError":          reflect.TypeOf((*q.ClientError)(nil)).Elem(),
			...
			"CommandValueSpec":     reflect.TypeOf((*q.CommandValueSpec)(nil)).Elem(),
			...
			"RetryableError":       reflect.TypeOf((*q.RetryableError)(nil)).Elem(),

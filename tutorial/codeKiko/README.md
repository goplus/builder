...
- [XBuilder游戏编程教材](#xbuilder游戏编程教材)
	- [目录](#目录)
	- [前言](#前言)
		- [欢迎来到编程的奇妙世界！](#欢迎来到编程的奇妙世界)
		- [这本教材会教你什么？](#这本教材会教你什么)
		- [这本教材有什么特别？](#这本教材有什么特别)
		- [开始之前你需要知道的](#开始之前你需要知道的)
		- [给家长和老师的话](#给家长和老师的话)
	- [准备好了吗？](#准备好了吗)
	- [第一章：初步 - 基础动作](#第一章初步---基础动作)
		...
		- [1.6 更复杂的路径](#16-更复杂的路径)
			...
			- [实用技巧](#实用技巧-1)
			- [小测验](#小测验-2)
		- [1.6 更复杂的路径](#16-更复杂的路径-1)
			- [学习目标](#学习目标-5)
			- [终极挑战：U 形路径](#终极挑战u-形路径-1)
			- [代码详解](#代码详解-5)
			- [运行效果详解](#运行效果详解-1)
			- [动手实践](#动手实践-5)
			- [重要发现](#重要发现-3)
...
1. 这段代码中一共有几次转向？几次前进？
2. 如果要让路径的横向距离变得更长，应该修改哪个参数？
3. 如果把第一个 `turn Right` 改成 `turn Left`，Kiko 会先朝哪个方向走？
4. 为什么第一段和第三段的步数相同（都是 180）？

<details>
<summary>点击查看答案</summary>

1. 3 次转向，3 次前进
2. 修改中间的 `step 200`，改成更大的数字
3. 会先朝下方走（从左转左就是下）
4. 因为要保持路径的对称性，向上走多少就要向下走多少
</details>
...
能否修改代码，让 Kiko 走一个镜像的路径（向右走而不是向左走）？
（提示：改变转向方向）

**挑战 3：设计新路径**

尝试设计一个 Z 形路径或矩形路径，需要用到：
- 多次转向
- 多次前进
- 精确的参数
